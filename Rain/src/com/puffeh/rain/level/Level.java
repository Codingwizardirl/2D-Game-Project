...
public class Level {
	...
	private byte grassAdded = 0;

	public static List<Entity> entities = new ArrayList<Entity>();
	private List<Projectile> projectiles = new ArrayList<Projectile>();
	private List<Particle> particles = new ArrayList<Particle>();
	private List<AnimatedTile> tiles_anim = new ArrayList<AnimatedTile>();
	...
	public Tile getTile(int x, int y) {
		...
		if (tiles[x + y * width] == Tile.col_spawn_grass) {
			if (grassAdded == 0) {
				grassAdded = 1;
				addTile(Tile.grass_anim_tile);
			}
			return Tile.grass_anim_tile;
		}
		...
		if (tiles[x + y * width] == Tile.col_spawn_water) {
			if (waterAdded == 0) {
				waterAdded = 1;
				addTile(Tile.water_anim_tile);
			}
			return Tile.water_anim_tile;
		}
		if (tiles[x + y * width] == Tile.col_zone_tile) return Tile.zone_tile;
